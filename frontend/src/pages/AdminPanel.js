...
function AdminPanel() {
  ...
  // ── Max enrollment for bar chart scaling ──
      ...
      <div className="container py-5">
        ...
        >
          <div className="d-flex align-items-center gap-2 mb-1">
            <span className="badge bg-danger bg-opacity-10 text-danger rounded-pill px-3 py-2 fw-semibold small">
              🛡️ Admin
            </span>
          </div>
          <h2 className="fw-bold text-dark display-6 mb-1">Admin Panel</h2>
          <p className="text-muted mb-0">Manage users, courses and view platform analytics.</p>
        </motion.div>
                            ...
                            return (
                              <div key={i} className="d-flex flex-column align-items-center flex-fill">
                                ...
                                <div
                                  ...
                                  style={{ height: `${pct || 4}%`, minHeight: 4, opacity: 0.85 }}
                      ...
                      <div className="card-body p-4">
                        ...
                        <div className="d-flex flex-column gap-3">
                          {analytics?.topCourses?.length === 0 && (
                            <p className="text-muted small">No enrollment data yet.</p>
                          )}
                            ...
                            return (
                              <div key={i}>
                                <div className="d-flex justify-content-between mb-1">
                                  <span className="small fw-semibold text-dark" style={{ fontSize: 13 }}>
                                ...
                                <div className="progress rounded-pill" style={{ height: 7 }}>
                                  <div
                                    className={`progress-bar rounded-pill ${colors[i]}`}
                                    style={{ width: `${pct}%` }}
                                  />
                                </div>
                              </div>
                      ...
                      <div className="card-body p-4">
                        ...
                        <div className="row g-3">
                          <div className="col-md-4">
                            <div className="d-flex align-items-center gap-3 p-3 rounded-3 bg-primary bg-opacity-10">
                              <span className="fs-4">🎓</span>
                              <div>
                                <div className="fw-bold text-primary fs-4">{analytics?.studentCount}</div>
                                <div className="text-muted small">Students</div>
                              </div>
                            </div>
                          </div>
                          <div className="col-md-4">
                            <div className="d-flex align-items-center gap-3 p-3 rounded-3 bg-warning bg-opacity-10">
                              <span className="fs-4">🧑‍🏫</span>
                              <div>
                                <div className="fw-bold text-warning fs-4">{analytics?.instructorCount}</div>
                            ...
                            <div className="d-flex align-items-center gap-3 p-3 rounded-3 bg-danger bg-opacity-10">
                              ...
                              <div>
                                <div className="fw-bold text-danger fs-4">
                                  {analytics?.totalUsers - analytics?.studentCount - analytics?.instructorCount}
                                </div>
